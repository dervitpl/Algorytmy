...
namespace task_3
{
    ...
    public class Task3
    {
        ...
        public static void Main()
        {
            ...
            {
                new Student() { Id = 1, Name = "marek", SureName = "wojcik"  , Birth = DateTime.Today},
                new Student() { Id = 2, Name = "mareka", SureName = "wojcika" , Birth =DateTime.Today },
                new Student() { Id = 3, Name = "mareks", SureName = "wojciks" , Birth = DateTime.Today},
                new Student() { Id = 4, Name = "marekd", SureName = "wojcikd" , Birth = DateTime.Today},
                new Student() { Id = 5, Name = "marekf", SureName = "wojcikf" , Birth = DateTime.Today},
