...
namespace lab11
{
    internal class Program
    {
        static void Main(string[] args)
        {
             ...
             try
            {
                ...
                if (graph.IsPath(1, 5)  && !graph.IsPath(3,2))
                {
                ...
                if (path.Count == 2 && path[0].Node == 4 && path[2].Node == 5 && path[0].Weight == 3 && path[1].Weight == 0.5)
                {
    ...
    //zaimplementuj powyzsze metody
    //implementacja z uzyiem macierzy
